...
function DegToDMS(Deg : double; mode :shortint; sep:string) :string ; overload;
...
function DegToDMS(Deg : double; mode : shortint; sep:string) :string ; overload;
begin
  Result := ChangeSeps(DegToDMS(Deg,mode),sep);
end;

function DegToDMS(Deg : double; isLatitude:Boolean; mode : shortint; sep:string) :string ; overload;
begin
  Result := ChangeSeps(DegToDMS(Deg,isLatitude,mode),sep);
end;

function DegToDMS(Deg : double; isLatitude:Boolean; mode : shortint; HideLitera: boolean; sep:string) :string ; overload;
begin
   Result := ChangeSeps(DegToDMS(Deg,isLatitude,mode,HideLitera),sep);
end;
