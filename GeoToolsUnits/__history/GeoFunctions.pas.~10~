...
uses GeoClasses, GeoMath, Math;
  ...
  var
       ...
       SuccessStr       :String = ' Перевод успешно выполнен!';
       NotFoundCSStr    :String = 'Исходная СК не найдена!';
       NotFoundICSStr   :String = 'Не найдены системы координат!';
       ProcStr          :String = 'Выполняю: ';
       ParamNotFoundStr :String = 'Не найдены параметры перехода!';
       ErrConvStr       :String = 'Ошибка перевода к: ';
implementation
...
begin
  ...
  { H = BLH[3] - высота топоцентрической плоскости над эллипсоидом в точке B, L.
    ...
    Здесь и далее - понятие топоцентрической плоскости применяется к Луне}
end;
