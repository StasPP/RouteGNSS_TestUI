...
begin
  ...
  /// ???? ÎÃÐÀÍÈ×ÈÒÜ  ÂÐÅÌÅÍÅÌ ÎÁÙÈÌ??? ToDO
  RTKStartTime := UTCToGPS(Rover.StartTime);
  RTKEndTime   := UTCToGPS(Rover.EndTime);
